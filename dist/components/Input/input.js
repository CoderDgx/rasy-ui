...
export var Input = function (props) {
    var _a;
    var disabled = props.disabled, size = props.size, icon = props.icon, prepend = props.prepend, append = props.append, style = props.style, className = props.className, onIconClick = props.onIconClick, restProps = __rest(props, ["disabled", "size", "icon", "prepend", "append", "style", "className", "onIconClick"]);
    var cnames = classNames("input-wrapper", className, (_a = {},
    ...
    return (React.createElement("div", { className: cnames, style: style },
        ...
        icon && (React.createElement("div", { className: "icon-wrapper" },
            React.createElement(Icon, { icon: icon, title: "title-" + icon, onClick: onIconClick }))),
